...
> **Current ship version: `2.1.8`** (branch `fix/search-menus`; merges 2.1.6 inline gear + 2.1.7 search overlay)
>
...
└── 2.1.8_release.zip                   ← recommended Orion installer (gitignored artifact)
```
