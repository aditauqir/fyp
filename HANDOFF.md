...
> **Current ship version: `2.1.9`** (branch `fix/search-menus`; 2.1.9 UX cleanup of search placement, strip, settings)
>
...
└── 2.1.9_release.zip                   ← recommended Orion installer (gitignored artifact)
```
