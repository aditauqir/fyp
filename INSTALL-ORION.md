# Install Fuck YouTube Premium on Orion iOS — v2.1.4

Version **2.1.4** keeps the 2.1.3 menu apply work, and fixes dropdown scrolling, adds a collapse arrow, repairs caption ownership, and makes Video quality easy to find in More. It uses the same Chrome Manifest V3 ZIP format as the known-good 2.0.20 Orion release.
...
1. [Install Orion Browser from the App Store](https://apps.apple.com/us/app/orion-browser-by-kagi/id1484498200), then download `2.1.4_release.zip` from the [latest GitHub Release](https://github.com/aditauqir/fyp/releases/latest) to **On My iPhone → Downloads** in Files. Do not unzip or rename it. If an older `2.1.4`–`2.1.8` beta is installed, uninstall it first so Orion can install this `2.1.4` release cleanly.
...
5. Open **On My iPhone → Downloads** and select `2.1.4_release.zip`.
