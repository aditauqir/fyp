# Install Fuck YouTube Premium on Orion iOS — v2.1.1

Version **2.1.1** keeps the stable channel work and fixes Lock Screen / Dynamic Island / Now Playing play-pause fighting the in-page controls. It uses the same Chrome Manifest V3 ZIP format as the known-good 2.0.20 Orion release.

## Install this

**Prefer the Orion release ZIP:**

`2.1.1_release_hotfix.zip`
...
1. [Install Orion Browser from the App Store](https://apps.apple.com/us/app/orion-browser-by-kagi/id1484498200), then download `2.1.1_release_hotfix.zip` from the [latest GitHub Release](https://github.com/aditauqir/fyp/releases/latest) to **On My iPhone → Downloads** in Files. Do not unzip or rename it. If a `2.1.4`–`2.1.8` beta is installed, uninstall it first because Orion cannot replace those higher numeric betas in place.
...
5. Open **On My iPhone → Downloads** and select `2.1.1_release_hotfix.zip`.
