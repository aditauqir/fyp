# Install Fuck YouTube Premium on Orion iOS — v2.0.16

Version **2.0.16** puts recommendations before native comments, prevents reply-editor focus zoom, keeps controls visible for eight seconds after interaction, and removes duplicate WebKit captions.

## Install this

**Prefer Chrome zip:**

`/Users/aditauqir/Downloads/userscript/fuck-youtube-premium-chrome-2.0.16.zip`

Firefox fallback:

`/Users/aditauqir/Downloads/userscript/fuck-youtube-premium-firefox-2.0.16.zip`
