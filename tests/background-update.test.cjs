...
const context = {
  ...
  fetch: async () => ({
    ...
    async json() {
      return {
        tag_name: 'v2.1.1',
        html_url: 'https://github.com/aditauqir/fyp/releases/tag/v2.1.1',
        assets: [
          {
            name: 'fuck-youtube-premium-orion-2.1.1.xpi',
            browser_download_url:
              'https://example.test/fuck-youtube-premium-orion-2.1.1.xpi',
          },
          {
            name: 'fuck-youtube-premium-chrome-2.1.1.zip',
            browser_download_url:
              'https://example.test/fuck-youtube-premium-chrome-2.1.1.zip',
          },
          {
            name: 'fuck-youtube-premium-firefox-2.1.1.zip',
            browser_download_url:
              'https://example.test/fuck-youtube-premium-firefox-2.1.1.zip',
          },
        ],
      };
    },
...
(async () => {
  ...
  assert.equal(chromeUpdate.latestVersion, '2.1.1');
